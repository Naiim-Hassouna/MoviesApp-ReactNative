    ...
    >
      ...
      <View className="flex-row justify-between absolute right-0 top-o mx-4 z-10 my-3">
        <TouchableOpacity
          ...
          className="rounded-xl p-2 bg-[#F59E0B] "
        >
          <XMarkIcon size="28" strokeWidth={2.5} color="black" />
        </TouchableOpacity>
      </View>
        ...
        <View className="mt-24">
          <View className="flex-row justify-center space-x-4">
            ...
            <View className="mt-6 w-1/2 space-y-3">
              <Text className="text-2xl text-whit font-bold text-left text-yellow-500">
                {person?.name}
              </Text>
          ...
          <View className="my-6 mx-4 space-y-2">
            <Text className="text-yellow-500 text-lg font-bold">Biography</Text>
