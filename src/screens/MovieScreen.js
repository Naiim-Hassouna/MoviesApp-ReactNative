    ...
    >
      ...
      <View className="w-full">
        ...
        <View className="z-20 w-full flex-row justify-between items-center px-4 mt-12 absolute">
          {/* Back Icon */}
          <View className="bg-black p-2 rounded-full items-center justify-center">
            <TouchableOpacity onPress={() => navigation.goBack()}>
              <ChevronLeftIcon size={33} strokeWidth={2} color="#F59E0B" className="font-bold" />
            </TouchableOpacity>
          </View>
      ...
      {/* Movie Details */}
      <View
        className="space-y-3 flex-1 bg-black relative py-4 mt-[-98] overflow-hidden"
        style={{
      ...
      >
        ...
        <View className="space-y-3 p-4">
          <Text className="text-yellow-500 text-left text-2xl font-bold tracking-widest">
            {movie?.title}
          </Text>
          ...
          {movie?.id ? (
            <View className="inline-flex items-center bg-[#F59E0B] p-2 rounded-lg">
              <Text className="text-black font-semibold text-base text-left">
                ...
                {<FontAwesomeIcon icon={faCalendar} size={15} color="#000" />}{}{" "}
